  ...
  return (
    <footer className=" w-full bg-bluish px-3 dark:bg-[rgb(15,22,36)] md:px-8  lg:px-32">
      <div className="my-auto mx-auto w-full max-w-[1350px] md:pt-12 2xl:pt-12 pb-4 flex flex-col items-center justify-center">
        <div>
          <img src={t("logo")} alt="logo" className="w-20 h-20" />
        </div>
        <p className="text-center">
          Crafted with React and TailwindCSS. Hosted on Github. <br />Developed by Hayati Qurrotul Uyun
          <p className="pb-2">{2024} &copy; hayatiuyun.github.io</p>
